...
void RetrogradeAudioProcessorEditor::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    auto backgroundImage = projectRoot.getChildFile("_Shared/Assets/backgrounds/retrograde-background.png");
    if (backgroundImage.existsAsFile())
    {
        ...
        if (backgroundImage.loadFileAsData(imageData))
        {
            ...
            htmlContent = htmlContent.replace("../../_Shared/Assets/backgrounds/retrograde-background.png", 
...
<head>
    ...
    <title>Retrograde - Authentication Required</title>
    <style>
        /* Set background to black immediately to prevent white flash */
        html, body { 
            background-color: #000000 !important; 
...
<body>
    <div class="auth-container">
        ...
        <div class="text-content">
            <h1 class="auth-title">RETROGRADE</h1>
...
//==============================================================================
juce::File RetrogradeAudioProcessorEditor::getAuthFile()
{
...
//==============================================================================
juce::String RetrogradeAudioProcessorEditor::loadAndDecryptLicenseFile()
{
...
//==============================================================================
void RetrogradeAudioProcessorEditor::timerCallback()
{
    if (!isAuthorized)
    {
...
void RetrogradeAudioProcessorEditor::notifyMIDINote(int noteNumber, int velocity)
{
