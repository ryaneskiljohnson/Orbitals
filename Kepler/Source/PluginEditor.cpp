...
<body>
    ...
    auto tempDir = juce::File::getSpecialLocation(juce::File::tempDirectory)
        .getChildFile("KeplerAuth_" + juce::String(juce::Time::currentTimeMillis()));
    tempDir.createDirectory();
...
//==============================================================================
bool KeplerAudioProcessorEditor::checkAuthorization()
{
    ...
    bool authorized = (expiration_date > juce::Time::getCurrentTime() && product_list.contains("kepler"));
...
//==============================================================================
juce::File KeplerAudioProcessorEditor::getAuthFile()
{
...
//==============================================================================
juce::String KeplerAudioProcessorEditor::loadAndDecryptLicenseFile()
{
