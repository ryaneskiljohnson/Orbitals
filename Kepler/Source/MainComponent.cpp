...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Kepler").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/kepler-background.png";
        auto imageFile = backgroundsDir.getChildFile ("kepler-background.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('kepler-background.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("kepler-background.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("kepler-background.png");
        imageFile.copyFileTo (tempImageFile);
    }
    
    auto tempFile = tempDir.getChildFile ("KeplerUI.html");
