...
//==============================================================================
/**
    ChipTune Audio FX Processor
    Classic arcade-style game that generates music based on gameplay
*/
class ChipTuneAudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    ChipTuneAudioProcessor();
    ~ChipTuneAudioProcessor() override;
