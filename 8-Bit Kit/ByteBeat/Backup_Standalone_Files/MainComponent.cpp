...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("ByteBeat").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/bytebeat.png";
        auto imageFile = backgroundsDir.getChildFile ("bytebeat.png");
        ...
        if (imageFile.existsAsFile())
        {
            ...
            juce::String newPattern = "url('bytebeat.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("bytebeat.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("bytebeat.png");
    ...
    auto tempFile = tempDir.getChildFile ("ByteBeatUI.html");
