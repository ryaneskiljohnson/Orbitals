...
//==============================================================================
class ByteBeatAudioProcessorEditor  : public juce::AudioProcessorEditor, public juce::Timer
{
public:
    ByteBeatAudioProcessorEditor (ByteBeatAudioProcessor&);
    ~ByteBeatAudioProcessorEditor() override;
...
private:
    ByteBeatAudioProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ByteBeatAudioProcessorEditor)
};
