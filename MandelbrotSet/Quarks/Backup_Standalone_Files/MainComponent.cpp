...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Quarks").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/quarks.png";
        auto imageFile = backgroundsDir.getChildFile ("quarks.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('quarks.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("quarks.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("quarks.png");
    ...
    auto tempFile = tempDir.getChildFile ("QuarksUI.html");
