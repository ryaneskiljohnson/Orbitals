...
void HadronAudioProcessorEditor::loadWebUI()
{
    ...
    juce::MessageManager::callAsync([this]()
    {
        ...
        if (!htmlFile.existsAsFile())
        {
            ...
            htmlFile = projectRoot.getChildFile ("Hadron").getChildFile ("UI").getChildFile ("index.html");
        }
...
void HadronAudioProcessorEditor::notifyMIDINote(int noteNumber, int velocity)
{
