...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Singularity").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/singularity.png";
        auto imageFile = backgroundsDir.getChildFile ("singularity.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('singularity.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("singularity.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("singularity.png");
    ...
    auto tempFile = tempDir.getChildFile ("SingularityUI.html");
