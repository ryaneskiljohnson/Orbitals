...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Mandelbrot").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/mandelbrot.png";
        auto imageFile = backgroundsDir.getChildFile ("mandelbrot.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('mandelbrot.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("mandelbrot.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("mandelbrot.png");
    ...
    auto tempFile = tempDir.getChildFile ("MandelbrotUI.html");
