...
void MandelbrotAudioProcessorEditor::loadWebUI()
{
    ...
    juce::MessageManager::callAsync([this]()
    {
        ...
        if (!htmlFile.existsAsFile())
        {
            ...
            htmlFile = projectRoot.getChildFile ("Mandelbrot").getChildFile ("UI").getChildFile ("index.html");
        }
...
void MandelbrotAudioProcessorEditor::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    auto backgroundImage = projectRoot.getChildFile("_Shared/Assets/backgrounds/mandelbrot-background.png");
    if (backgroundImage.existsAsFile())
    {
        ...
        if (backgroundImage.loadFileAsData(imageData))
        {
            ...
            htmlContent = htmlContent.replace("../../_Shared/Assets/backgrounds/mandelbrot-background.png", 
...
void MandelbrotAudioProcessorEditor::notifyMIDINote(int noteNumber, int velocity)
{
