...
function updateMeterColors() {
    ...
    if (state.bypass) {
        ...
        if (inputMeterFill) {
            inputMeterFill.style.background = 'linear-gradient(to right, rgba(255, 215, 0, 0.3) 0%, rgba(255, 215, 0, 0.6) 50%, #ffd700 100%)';
            inputMeterFill.style.boxShadow = '0 0 8px rgba(255, 215, 0, 0.8)';
        }
        if (outputMeterFill) {
            outputMeterFill.style.background = 'linear-gradient(to right, rgba(255, 215, 0, 0.3) 0%, rgba(255, 215, 0, 0.6) 50%, #ffd700 100%)';
            outputMeterFill.style.boxShadow = '0 0 8px rgba(255, 215, 0, 0.8)';
        }
    }
}
