...
void PlanckAudioProcessorEditor::loadWebUI()
{
    ...
    juce::MessageManager::callAsync([this]()
    {
        ...
        if (!htmlFile.existsAsFile())
        {
            ...
            htmlFile = projectRoot.getChildFile ("Planck").getChildFile ("UI").getChildFile ("index.html");
        }
...
void PlanckAudioProcessorEditor::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (backgroundImage.existsAsFile())
    {
        ...
        if (backgroundImage.loadFileAsData(imageData))
        {
            ...
            htmlContent = htmlContent.replace("../../_Shared/Assets/backgrounds/planck.png", 
...
void PlanckAudioProcessorEditor::notifyMIDINote(int noteNumber, int velocity)
{
