...
function updateMeterColors() {
    ...
    if (state.bypass) {
        ...
        if (inputMeterFill) {
            inputMeterFill.style.background = 'linear-gradient(to right, rgba(0, 229, 255, 0.3) 0%, rgba(0, 229, 255, 0.6) 50%, #00e5ff 100%)';
            inputMeterFill.style.boxShadow = '0 0 8px rgba(0, 229, 255, 0.8)';
        }
        if (outputMeterFill) {
            outputMeterFill.style.background = 'linear-gradient(to right, rgba(0, 229, 255, 0.3) 0%, rgba(0, 229, 255, 0.6) 50%, #00e5ff 100%)';
            outputMeterFill.style.boxShadow = '0 0 8px rgba(0, 229, 255, 0.8)';
        }
    }
}
