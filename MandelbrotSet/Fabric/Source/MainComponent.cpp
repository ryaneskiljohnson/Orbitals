...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Fabric").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/fabric.png";
        auto imageFile = backgroundsDir.getChildFile ("fabric.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('fabric.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("fabric.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("fabric.png");
    ...
    auto tempFile = tempDir.getChildFile ("FabricUI.html");
