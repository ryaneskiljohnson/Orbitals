...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Rabbithole").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/rabbithole.png";
        auto imageFile = backgroundsDir.getChildFile ("rabbithole.png");
        ...
        if (imageFile.existsAsFile())
        {
            ...
            juce::String newPattern = "url('rabbithole.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("rabbithole.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("rabbithole.png");
    ...
    auto tempFile = tempDir.getChildFile ("RabbitholeUI.html");
