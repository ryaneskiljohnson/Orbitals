...
RabbitholeAudioProcessorEditor::~RabbitholeAudioProcessorEditor()
{
}
...
void RabbitholeAudioProcessorEditor::loadWebUI()
{
    ...
    juce::MessageManager::callAsync([this]()
    {
        ...
        if (!htmlFile.existsAsFile())
        {
            ...
            htmlFile = projectRoot.getChildFile ("Rabbithole").getChildFile ("UI").getChildFile ("index.html");
        }
...
void RabbitholeAudioProcessorEditor::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    auto backgroundImage = projectRoot.getChildFile("_Shared/Assets/backgrounds/rabbithole.png");
    if (backgroundImage.existsAsFile())
    {
        ...
        if (backgroundImage.loadFileAsData(imageData))
        {
            ...
            htmlContent = htmlContent.replace("../../_Shared/Assets/backgrounds/rabbithole.png", 
    ...
    auto tempDir = juce::File::getSpecialLocation(juce::File::tempDirectory)
        .getChildFile("RabbitholeUI_" + juce::String(juce::Time::currentTimeMillis()));
...
//==============================================================================
void RabbitholeAudioProcessorEditor::loadAuthScreen()
{
...
<head>
    ...
    <title>Rabbithole - Authentication Required</title>
    <style>
        /* Set background to black immediately to prevent white flash */
        html, body { 
            background-color: #000000 !important; 
...
//==============================================================================
juce::String RabbitholeAudioProcessorEditor::loadAndDecryptLicenseFile()
{
...
void RabbitholeAudioProcessorEditor::sendMeteringData()
{
