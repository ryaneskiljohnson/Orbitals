...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Entanglement").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/entanglement.png";
        auto imageFile = backgroundsDir.getChildFile ("entanglement.png");
        ...
        if (imageFile.existsAsFile())
        {
            ...
            juce::String newPattern = "url('entanglement.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("entanglement.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("entanglement.png");
    ...
    auto tempFile = tempDir.getChildFile ("EntanglementUI.html");
