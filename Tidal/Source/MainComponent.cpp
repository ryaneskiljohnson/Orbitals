...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Tidal").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/tidal-background.png";
        auto imageFile = backgroundsDir.getChildFile ("tidal-background.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('tidal-background.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("tidal-background.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("tidal-background.png");
    ...
    auto tempFile = tempDir.getChildFile ("TidalUI.html");
