...
void IonAudioProcessorEditor::loadWebUI()
{
    ...
    juce::MessageManager::callAsync([this]()
    {
        ...
        if (!htmlFile.existsAsFile())
        {
            ...
            htmlFile = projectRoot.getChildFile ("Ion").getChildFile ("UI").getChildFile ("index.html");
        }
...
void IonAudioProcessorEditor::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    auto backgroundImage = projectRoot.getChildFile("_Shared/Assets/backgrounds/ion-background.png");
    if (backgroundImage.existsAsFile())
    {
        ...
        if (backgroundImage.loadFileAsData(imageData))
        {
            ...
            htmlContent = htmlContent.replace("../../_Shared/Assets/backgrounds/ion-background.png", 
...
//==============================================================================
void IonAudioProcessorEditor::loadAuthScreen()
{
...
<head>
    ...
    <title>Ion - Authentication Required</title>
    <style>
        /* Set background to black immediately to prevent white flash */
        html, body { 
            background-color: #000000 !important; 
...
<body>
    ...
    auto tempDir = juce::File::getSpecialLocation(juce::File::tempDirectory)
        .getChildFile("IonAuth_" + juce::String(juce::Time::currentTimeMillis()));
    tempDir.createDirectory();
