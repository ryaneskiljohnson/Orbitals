...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Ion").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/ion-background.png";
        auto imageFile = backgroundsDir.getChildFile ("ion-background.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('ion-background.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("ion-background.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("ion-background.png");
        imageFile.copyFileTo (tempImageFile);
    }
    
    auto tempFile = tempDir.getChildFile ("IonUI.html");
