...
void MainComponent::loadMainUI()
{
    ...
    auto htmlFile = projectRoot.getChildFile ("Perihelion").getChildFile ("UI").getChildFile ("index.html");
...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/perihelion-background.png";
        auto imageFile = backgroundsDir.getChildFile ("perihelion-background.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('perihelion-background.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("perihelion-background.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("perihelion-background.png");
    ...
    auto tempFile = tempDir.getChildFile ("PerihelionUI.html");
