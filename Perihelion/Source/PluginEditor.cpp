...
void PerihelionAudioProcessorEditor::loadWebUI()
{
    ...
    juce::MessageManager::callAsync([this]()
    {
        ...
        if (!htmlFile.existsAsFile())
        {
            ...
            htmlFile = projectRoot.getChildFile ("Perihelion").getChildFile ("UI").getChildFile ("index.html");
        }
...
<body>
    <div class="auth-container">
        ...
        <div class="text-content">
            <h1 class="auth-title">PERIHELION</h1>
...
//==============================================================================
juce::File PerihelionAudioProcessorEditor::getAuthFile()
{
...
//==============================================================================
juce::String PerihelionAudioProcessorEditor::loadAndDecryptLicenseFile()
{
