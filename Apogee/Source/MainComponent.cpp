...
void MainComponent::loadHTMLFile (const juce::File& htmlFile)
{
    ...
    if (cssFile.existsAsFile())
    {
        ...
        juce::String searchPattern = "../../_Shared/Assets/backgrounds/apogee-background.png";
        auto imageFile = backgroundsDir.getChildFile ("apogee-background.png");
        
        if (imageFile.existsAsFile())
        {
            juce::String oldPattern = "url('" + searchPattern + "')";
            juce::String newPattern = "url('apogee-background.png')";
    ...
    auto imageFile = backgroundsDirForImage.getChildFile ("apogee-background.png");
    if (imageFile.existsAsFile())
    {
        auto tempImageFile = tempDir.getChildFile ("apogee-background.png");
    ...
    auto tempFile = tempDir.getChildFile ("ApogeeUI.html");
